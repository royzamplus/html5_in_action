(function() {
    var SuperEditor = function() {
        ...
        window.requestFileSystem = window.requestFileSystem
                                ...
                                || window.msRequestFileSystem || false;
        ...
        if (requestFileSystem && storageInfo) {
            ...
            // Building the file list UI from an array of files
            ...
            // Importing files from the user's computer
            ...
            // Allowing users to import files by dropping them in the application
        ...
        // Allowing users to export files by dragging them out of the app
